    ...
    final List<Map<String, dynamic>> navigationList = [
      {
        ...
        "onTap": () async {
          ...
          final subject = Uri.encodeComponent('Walli Verse Feedback.');
      ...
      },
      {
        ...
        "onTap": () {
          GetSmack(
            ...
            body: 'This feature is missing currently. Will be added as soon as the app get deployed at play store.',
          );
        },
      },
      {
        ...
        "onTap": () async {
          ...
          if (File('${tempDir.path}/icon.png').existsSync()) {
            ...
            file = await File('${tempDir.path}/icon.png').create(recursive: true);
